    ...
    return (
        <>
            <Container className='my-5'>
                <Row>
                    <Col lg={6}>
                        <img className='w-100 rounded-3' src="https://cdn.pixabay.com/photo/2019/08/14/09/53/consulting-4405260_960_720.jpg" alt="" />
                    </Col>
                    <Col lg={6}>
                        <h1 className='fw-bolder display-2 pt-5 '>Welcome to <span className='text-warning'>ALEM Life Coach</span></h1>
